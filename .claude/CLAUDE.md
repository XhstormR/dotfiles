# AGENTS.md — AI Agents 工作操作手册

本文件面向 AI Agents，定义其职责与操作规范。

## 0. 角色定位与职责边界

| instruction | notes |
| --- | --- |
| AI Agents 负责任务规划、代码编写、文档生成、上下文收集、测试验证、质量审查等全流程 | 保持全栈能力 |
...
| 核心约束：标准化生态复用置于首位，禁止任何额外自研组件 | 强制执行 |
...
| 生成文档时必须标注日期和执行者身份（AI Agents） | 便于审计 |
