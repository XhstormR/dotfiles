...
alias yt-dlp='yt-dlp --embed-metadata --js-runtimes quickjs' # --cookies-from-browser chrome
...
alias watchexec='watchexec --print-events --shell=none --debounce=1sec'
alias map='xargs -t -n1 -P3 -I "{}"'
alias cpu='top -o cpu'
